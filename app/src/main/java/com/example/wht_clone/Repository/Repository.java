package com.example.wht_clone.Repository;
...
//import com.example.wht_clone.model.ChatMessage;
import com.example.wht_clone.views.GroupsActivity;
...
public class Repository {
    ...
    public MutableLiveData<List<Chatmessage>> getMessagesLiveData(String groupName) {
        ...
        groupReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                messagesLiveData.postValue(chatmessageList);
    ...
    public void sendmessage(String messagetext,String chatgroup){
        ...
        if(!messagetext.trim().equals("")){
            ...
            String randomkry=ref.push().getKey();
            ref.child(randomkry).setValue(msg);
